...
from field_squad.api.routes import employee_module
from field_squad.api.routes import app_user_auth_module
from field_squad.api.routes import app_dashboard_module
from field_squad.api.routes import app_attendance_module
from field_squad.api.routes import app_request_module
from field_squad.api.routes import app_sidebar_module
from field_squad.api.routes import attendance_module
from field_squad.api.routes import app_ai_agent_module

#web
from field_squad.api.routes import web_user_module
from field_squad.api.routes import web_user_auth_module
from field_squad.api.routes import web_category_module
from field_squad.api.routes import web_product_module
from field_squad.api.routes import web_lead_module
from field_squad.api.routes import web_customer_module
